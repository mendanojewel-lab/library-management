      ...
      <Tabs
        tabs={[
          ...
          },
          {
            ...
            content: (
              <div>
                <h3 className="font-semibold mb-2">Returned Books</h3>
                <div className="space-y-2">
                  {borrowsAll.length === 0 && (
                    <div className="text-sm text-gray-600">
                      No returns found.
      ...
      >
        <form onSubmit={handleCreateOrUpdate} className="space-y-3">
          ...
          <Input
            ...
            type="number"
            value={String(form.availableCopies)}
            onChange={(e) =>
